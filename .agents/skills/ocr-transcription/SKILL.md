...
- **نطاق دليل العمل ومسار الحفظ (`Working Directory & Output Scope`)**: يلزم على الوكيل دائماً ضبط دليل العمل (`Cwd`) على مجلد المشروع المخصص (`ocr workflow/`) عند تشغيل السكربتات؛ لضمان كتابة وحفظ كافة المخرجات والمجلدات المؤقتة والنهائية (`output_parts/`, `output_images/`, `md/`, `word/`) حتماً داخل مجلد مشروع `ocr workflow/` وحظر تسربها أو إنشائها في الجذر الكلي لمساحة العمل.
